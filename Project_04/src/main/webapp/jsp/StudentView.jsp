rt="com.rays.pro4.Util.HTMLUtility"%>
	...
	<form action="<%=ORSView.STUDENT_CTL%>" method="post">
		...
		<center>
			...
			<input type="hidden" name="modifiedby"
				...
				name="createddatetime"value=date =<%=bean.getCreatedDatetime()%>">
			...
			<table>
				...
				<tr>
					...
					<td><%=HTMLUtility.getList("collegename", String.valueOf(bean.getCollegeId()), list) %></td>
